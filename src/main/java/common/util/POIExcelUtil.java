...
public class POIExcelUtil {
    ...
    private static short[]          HHmmss            = { 20, 32, 190, 191, 192 };
    private static List<short[]>    yyyyMMddList      = Arrays.asList(yyyyMMdd);
    private static List<short[]>    hhMMssList        = Arrays.asList(HHmmss);
    ...
    public static void main(String[] args) {
        ...
        String src_xlspath = "D:\\支行网点地址及客户经理统计.xlsx";
     ...
     * @throws IOException
     */
    public List<Map<String, String>> readExcel(String xlsPath) throws IOException {
     ...
     * @throws IOException
     */
    public List<Map<String, String>> readExcel_xlsx() throws IOException {
     ...
     * @throws Exception
     */
    public List<Map<String, String>> readExcel_xlsx(String xlsPath) throws IOException {
        // 判断文件是否存在  
        File file = new File(xlsPath);
        if (!file.exists()) {
     ...
     */
    public List<Map<String, String>> readExcel_xls() throws IOException {
     ...
     * @Date : 2014-9-11 上午09:53:21
     */
    public List<Map<String, String>> readExcel_xls(String xlsPath) throws IOException {
            ...
            switch (cell.getCellType()) {
                ...
                case Cell.CELL_TYPE_NUMERIC:
                    if (DateUtil.isCellDateFormatted(cell)) {
                        ...
                        Double numberDate = new BigDecimal(cell.getNumericCellValue()).setScale(4,
            ...
            for (int i = startReadPos; i <= lastRowNum + endReadPos; i++) {
                ...
                if (row != null) {
                    ...
                    for (int j = 0; j < row.getLastCellNum(); j++) {
                        ...
                        rowdatas.put(getCharByNum(t) + getCharByNum(j) + "", value);
                        out(value + "", false);
                    }
     ...
     * @return
     */
    public String getCharByNum(int number) {
