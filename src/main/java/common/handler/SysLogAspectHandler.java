...
//    @Pointcut(value = "execution(* com.gaoshiqing.*.*.controller.*.*(..))")
//    public void controllerAspect() {
//    }
//
//    @After("controllerAspect() && @annotation(log) && args(request,..)")
//    //@After(value = "execution(* com.com.blogadmin.gaoshiqing.*.*.action.*.*(..)) && @annotation(log)&&args(request,..)")
